...
import {addToFavorites, getSingleFavorite, removeToFavorites} from "../../../configs";
import useIsLogin from "../../../hooks/useIsLogin";
import useCards from "../../../hooks/useCards";
import useAlert from "../../../hooks/useAlert";

const LikeMoreButton = ({productId, productBase, getProductBase, setProductBase}) => {
	const [isLike, setIsLike] = React.useState(false)
	const {isAuth} = useIsLogin()
	const {actions} = useCards()
	const {actions: {sweetAlert}} = useAlert()
		...
		<div className={c.likedBtn}>
			{
				!isLike ? (
					...
					>
						<MdFavorite
							style={{color: '#e05353', fontSize: 22}}
						/>
						<p>В избранном</p>
					</span>
				)
